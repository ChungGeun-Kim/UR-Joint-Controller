...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class PinchSlider : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusHandler
    {
        ...
        private float sliderStartDistance = -5.0f;
        ...
        private float sliderEndDistance = 5.0f;
        ...
        public IMixedRealityPointer activePointer;
        ...
        public void OnPointerDragged(MixedRealityPointerEventData eventData)
        {
            if (eventData.Pointer == activePointer && !eventData.used)
            {
                ...
                SliderValue = Mathf.Clamp(startSliderValue + handDelta / SliderTrackDirection.magnitude, 0.0f, 1.0f);
