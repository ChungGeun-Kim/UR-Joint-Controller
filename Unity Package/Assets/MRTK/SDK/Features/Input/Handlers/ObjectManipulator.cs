...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class ObjectManipulator : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler
    {
        ...
        public Quaternion objectToGripRotation;
        private bool isNearManipulation;
        public bool isManipulationStarted;
        ...
        public Vector3 GetPointersGrabPoint()
        {
        ...
        public MixedRealityPose GetPointersPose()
        {
        ...
        public MixedRealityTransform HandleOneHandMoveUpdated()
        {
            ...
            //Debug.Log("grab" + targetTransform.Position);
        ...
        public void ApplyTargetTransform(MixedRealityTransform targetTransform)
        {
            if (rigidBody == null)
            {
            ...
            else
            {
                ...
                {
                    rigidBody.angularVelocity = (((1f - Mathf.Pow(rotateLerpTime, Time.deltaTime)) / Time.deltaTime) * (axis.normalized * angle * Mathf.Deg2Rad))/100;
                }
        ...
        public Vector3[] GetHandPositionArray()
        {
        ...
        public PointerData GetFirstPointer()
        {
        ...
        public bool TryGetGripRotation(IMixedRealityPointer pointer, out Quaternion rotation)
        {
